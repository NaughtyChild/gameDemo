...
public class C2DArc extends C2DLineBase {
    ...
    /**
     * @param Other Arc to which this will be assigned.
     */
     ...
     * @param PtTo           The point the arc is to go from.
     * @param dRadius        The point the arc is to go to.
     * @param bCentreOnRight The corresponding circles radius.
     * @param bArcOnRight    Whether the centre is on the right.
     */
    ...
    /**
     * @param Arcline        The line defining the start and end point of the arc.
     * @param dRadius        The corresponding circles radius.
     * @param bCentreOnRight Whether the centre is on the right.
     * @param bArcOnRight    Whether the arc is to the right of the line.
     */
     ...
     * Assignment
     *
     * @param other The arc to set this to.
     */
     ...
     *
     * @param Arcline The line defining the start and end point of the arc.
     * @param ptOnArc A point on the arc.
     */
     ...
     *
     * @param Rect The bounding rectangle to recieve the result.
     */
     ...
     *
     * @param Other           The other line as an abstract base class.
     * @param IntersectionPts The interection point list to recieve the result.
     * @return
     */
     ...
     *
     * @param TestPoint The test point.
     * @param ptOnThis  The closest point on this to the given point as a returned value.
     * @return
     */
     ...
     *
     * @param Other     The test point.
     * @param ptOnThis  The closest point on this to the other as a returned value.
     * @param ptOnOther The closest point on the other to this as a returned value.
     * @return
     */
     ...
     *
     * @param Testline The projection line.
     * @param Interval The interval to recieve the result.
     */
     ...
     *
     * @param Vector   The projection vector.
     * @param Interval The interval to recieve the result.
     */
     ...
     * @param Origin  The origin about which this is to be grown.
     */
     ...
     *
     * @param point The point through which this will be reflected.
     */
     ...
     *
     * @param Testline The line through which this will be reflected.
     */
     ...
     *
     * @param PtsOnline The points defining how the line is to be split.
     * @param lineSet   The line set to recieve the result.
     */
    @Override
     ...
     *
     * @param grid The grid object to snap this to.
     */
